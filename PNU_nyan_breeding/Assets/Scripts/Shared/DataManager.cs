...
public class DataManager: MonoBehaviour
{
    ...
    private string[] professorEventPath={"Json/NpcEventProfessor/professorEvent0", "Json/NpcEventProfessor/professorEvent1","Json/NpcEventProfessor/professorEvent2","Json/NpcEventProfessor/professorEvent3","Json/NpcEventProfessor/professorEvent4","Json/NpcEventProfessor/professorEvent5","Json/NpcEventProfessor/professorEvent6","Json/NpcEventProfessor/professorEvent7","Json/NpcEventProfessor/professorEvent8","Json/NpcEventProfessor/professorEvent9"};
    public List<Dictionary<int, ProfessorEvent>> blackCatEvent=new List<Dictionary<int, ProfessorEvent>>();
    private string[] blackCatEventPath={"Json/NpcEventBlackCat/blackCatEvent0", "Json/NpcEventBlackCat/blackCatEvent1","Json/NpcEventBlackCat/blackCatEvent2","Json/NpcEventBlackCat/blackCatEvent3","Json/NpcEventBlackCat/blackCatEvent4","Json/NpcEventBlackCat/blackCatEvent5","Json/NpcEventBlackCat/blackCatEvent6","Json/NpcEventBlackCat/blackCatEvent7","Json/NpcEventBlackCat/blackCatEvent8","Json/NpcEventBlackCat/blackCatEvent9"};
    public List<Dictionary<int, ProfessorEvent>> butlerEvent=new List<Dictionary<int, ProfessorEvent>>();
    private string[] butlerEventPath={"Json/NpcEventButler/butlerEvent0", "Json/NpcEventButler/butlerEvent1","Json/NpcEventButler/butlerEvent2","Json/NpcEventButler/butlerEvent3","Json/NpcEventButler/butlerEvent4","Json/NpcEventButler/butlerEvent5","Json/NpcEventButler/butlerEvent6","Json/NpcEventButler/butlerEvent7","Json/NpcEventButler/butlerEvent8","Json/NpcEventButler/butlerEvent9"};
    public List<Dictionary<int, ProfessorEvent>> presidentEvent=new List<Dictionary<int, ProfessorEvent>>();
    private string[] presidentEventPath={"Json/NpcEventPresident/presidentEvent0", "Json/NpcEventPresident/presidentEvent1","Json/NpcEventPresident/presidentEvent2","Json/NpcEventPresident/presidentEvent3","Json/NpcEventPresident/presidentEvent4","Json/NpcEventPresident/presidentEvent5","Json/NpcEventPresident/presidentEvent6","Json/NpcEventPresident/presidentEvent7","Json/NpcEventPresident/presidentEvent8","Json/NpcEventPresident/presidentEvent9"};
